...
# DESCRIPTION
# ----------------------------------------------------------------------------------------------------
## @file    extPySideP2Windows/packageEnvLib.py @brief [ FILE   ] - Package environment module.
## @package extPySideP2Windows.packageEnvLib    @brief [ MODULE ] - Package environment module.
